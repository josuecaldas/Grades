...
c(2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2,3,1,4,1,2)
```
...
sim_lasso <- list(
  ...
  fixed = list(x1 = list(var_type = 'continuous', mean = 25, sd = 5),
               ...
               x4 = list(var_type = 'continuous', mean = 34, sd = 6),
               x5 = list(var_type = 'continuous', mean = 24, sd = 2)),
  error = list(variance = 15),
  sample_size = 50,
  reg_weights = c(1, 4, 3, 5, 3, 6)
)
...
```{r}
data_lasso2 <- matrix(rnorm(n = 40*50, mean = 34, sd = 4), ncol = 40L)
